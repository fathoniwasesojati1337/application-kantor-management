  ...
  <body>
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">Tony Template
        </div>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="general-pages">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="/pengumpulan/proyek">Pengumpulan</a></li>
                  <li class="nav-item"> <a class="nav-link" href="/proyek/list">Proyek List</a></li>
                </ul>
              </div>
            </li>
